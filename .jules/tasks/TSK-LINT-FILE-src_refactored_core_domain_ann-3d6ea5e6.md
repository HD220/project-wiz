# Tarefa: LINT-FILE-src_refactored_core_domain_ann-3d6ea5e6 - Fix all 2 lint issues in src_refactored/core/domain/annotation/value-objects/annotation-text.vo.ts
