# Tarefa: LINT-FILE-src_refactored_core_applicatio-176e2323 - Fix all 1 lint issues in src_refactored/core/application/use-cases/project/list-projects.use-case.ts
