# Tarefa: LINT-FILE-src_refactored_core_applicatio-20d7be72 - Fix all 2 lint issues in src_refactored/core/application/use-cases/job/create-job.use-case.ts
