# Tarefa: LINT-FILE-src_refactored_core_domain_llm-d800f43e - Fix all 2 lint issues in src_refactored/core/domain/llm-provider-config/value-objects/llm-provider-config-name.vo.ts
