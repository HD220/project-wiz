# Tarefa: LINT-FILE-src_refactored_core_domain_age-7277d344 - Fix all 2 lint issues in src_refactored/core/domain/agent/value-objects/agent-temperature.vo.ts
