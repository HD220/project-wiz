...
| FE-SETUP-003.3| Criar Rota Exemplo (Index) e Verificar `routeTree.gen.ts` | Pendente | FE-SETUP-003.2 | P0 | Jules | [TSK-FE-SETUP-003.3.md](./tasks/TSK-FE-SETUP-003.3.md) | Criar `app/index.tsx`, checar codegen |
