...
| QSYS-1.2     | QSYS-F1.2: Definir/Confirmar Interface IJobRepository | Concluído | QSYS-1.1            | P1         | Jules       | [TSK-QSYS-1.2.md](./tasks/TSK-QSYS-1.2.md) | Interface do repositório de jobs definida. |
