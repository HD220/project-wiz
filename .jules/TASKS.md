...
| FE-SETUP-002.1| Executar `npx shadcn-ui@latest init` e configuração inicial | Pendente | FE-SETUP-002 | P0 | Jules | [TSK-FE-SETUP-002.1.md](./tasks/TSK-FE-SETUP-002.1.md) | Parte 1 Shadcn |
