// src_refactored/core/application/use-cases/agent-internal-state/load-agent-internal-state.schema.ts
import { z } from 'zod';

/**
 * Input schema for LoadAgentInternalStateUseCase.
 */
export const LoadAgentInternalStateUseCaseInputSchema = z.object({
...
export type LoadAgentInternalStateUseCaseInput = z.infer<typeof LoadAgentInternalStateUseCaseInputSchema>;
...
export type LoadAgentInternalStateUseCaseOutput = z.infer<typeof LoadAgentInternalStateUseCaseOutputSchema>;
