// src_refactored/core/application/use-cases/annotation/list-annotations.schema.ts
import { z } from 'zod';

/**
 * Input schema for ListAnnotationsUseCase, allowing filtering and pagination.
 */
export const ListAnnotationsUseCaseInputSchema = z.object({
...
export type ListAnnotationsUseCaseInput = z.infer<typeof ListAnnotationsUseCaseInputSchema>;
...
export const ListAnnotationsUseCaseOutputSchema = z.object({
  annotations: z.array(AnnotationListItemSchema).describe("Array of annotation list items for the current page."),
  totalCount: z.number().int().describe("Total number of annotations matching the filters."),
...
export type ListAnnotationsUseCaseOutput = z.infer<typeof ListAnnotationsUseCaseOutputSchema>;
