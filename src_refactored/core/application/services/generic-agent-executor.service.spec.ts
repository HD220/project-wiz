...
import { IJobRepository } from '@/src_refactored/core/domain/job/ports/i-job.repository';
import { IAgentInternalStateRepository } from '@/src_refactored/core/domain/agent/ports/i-agent-internal-state.repository';
import { ILogger } from '@/src_refactored/core/common/services/i-logger.service';
import { Job } from '@/src_refactored/core/domain/job/job.entity';
import { Agent } from '@/src_refactored/core/domain/agent/agent.entity';
import { JobId } from '@/src_refactored/core/domain/job/value-objects/job-id.vo';
import { JobName } from '@/src_refactored/core/domain/job/value-objects/job-name.vo';
import { AgentId } from '@/src_refactored/core/domain/agent/value-objects/agent-id.vo';
import { Result } from '@/src_refactored/shared/result';
import { ApplicationError } from '../common/errors';
import { ActivityContext } from '@/src_refactored/core/domain/job/value-objects/activity-context.vo';
import { ActivityHistory } from '@/src_refactored/core/domain/job/value-objects/activity-history.vo';
import { AgentPersonaTemplate } from '@/src_refactored/core/domain/agent/agent-persona-template.vo';
import { PersonaId } from '@/src_refactored/core/domain/agent/value-objects/persona/persona-id.vo';
import { PersonaName } from '@/src_refactored/core/domain/agent/value-objects/persona/persona-name.vo';
import { PersonaRole } from '@/src_refactored/core/domain/agent/value-objects/persona/persona-role.vo';
import { PersonaGoal } from '@/src_refactored/core/domain/agent/value-objects/persona/persona-goal.vo';
import { LLMProviderConfigId } from '@/src_refactored/core/domain/llm-provider-config/value-objects/llm-provider-config-id.vo';
