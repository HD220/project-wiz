...
export let mockUserProfile: UserProfile = {
  ...
  profilePictureUrl: 'https://example.com/avatar.png', // Replace with a real or placeholder image if needed
...
export const updateMockUserProfile = (updatedProfile: Partial<UserProfile>): UserProfile => {
  mockUserProfile = { ...mockUserProfile, ...updatedProfile, updatedAt: new Date().toISOString() };
