...
import type { CreateAgentInstanceRequest, CreateAgentInstanceResponse, AgentInstance, UpdateAgentInstanceRequest, UpdateAgentInstanceResponse, PersonaTemplate, LLMConfig } from '@/shared/ipc-types';
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <AgentPersonaTemplateSelectField control={form.control} personaTemplates={personaTemplates} />
        <AgentLLMConfigSelectField control={form.control} llmConfigs={llmConfigs} />
