import { Users, Bot as BotIcon, Search, UserPlus, Zap, CheckCircle, AlertTriangle, ListChecks } from 'lucide-react';
import React, { useState } from 'react';

// UserCircle2 from lucide-react was unused
// Avatar, AvatarFallback, AvatarImage from '@/presentation/ui/components/ui/avatar' were unused
// Tooltip, TooltipContent, TooltipProvider, TooltipTrigger from '@/presentation/ui/components/ui/tooltip' were unused
...
// Export for use in ParticipantListItem.tsx
export type StatusIndicatorMap = Record<Required<Participant>['status'], { color: string; label: string, icon?: React.ElementType }>;
          ...
          <div className="p-2 pt-1">
            ...
            <div className="space-y-0.5">
              {humanParticipants.map(participant => (
                <ParticipantListItem key={participant.id} participant={participant} statusIndicatorMap={statusIndicatorMap} />
              ))}
            </div>
          </div>
        )}
