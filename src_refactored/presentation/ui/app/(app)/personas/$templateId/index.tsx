      ...
      <Card className="overflow-hidden">
        <CardHeader className="bg-slate-50 dark:bg-slate-800/50 p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <CardTitle className="text-2xl lg:text-3xl">{template.name}</CardTitle>
        ...
        <CardContent className="p-6 space-y-5">
          ...
          {template.backstory && (
            <>
              <Separator />
              <div>
                <h3 className="text-md font-semibold text-slate-700 dark:text-slate-300 mb-1.5">Backstory / Contexto</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400 whitespace-pre-line">{template.backstory}</p>
              </div>
            </>
          )}
          ...
          {template.toolNames && template.toolNames.length > 0 && (
            <>
              <Separator />
              <div>
                <h3 className="text-md font-semibold text-slate-700 dark:text-slate-300 mb-2">Ferramentas Permitidas</h3>
                <div className="flex flex-wrap gap-2">
                  <TooltipProvider delayDuration={100}>
                    {template.toolNames.map(toolName => {
