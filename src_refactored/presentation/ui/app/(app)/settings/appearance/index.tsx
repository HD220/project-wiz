...
import { RadioGroup, RadioGroupItem } from "@/presentation/ui/components/ui/radio-group";
    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-2xl mx-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Personalize o tema visual da aplicação.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <Label className="text-base font-medium mb-2 block">Tema da Interface</Label>
            <RadioGroup
              value={theme}
            ...
            >
              {themeOptions.map((option) => (
                ...
                >
                  ...
                  <option.icon className={cn("h-8 w-8 mb-2", theme === option.value ? "text-primary" : "text-muted-foreground")} />
          ...
          <div className="mt-6">
            <h3 className="text-lg font-medium mb-2">Pré-visualização do Tema</h3>
            <div className="p-6 rounded-lg border bg-background text-foreground">
              <h4 className="font-semibold text-xl mb-2 text-primary">Título de Exemplo</h4>
              <p className="mb-1">Este é um parágrafo de exemplo para demonstrar o tema atual.</p>
              <Button variant="default" size="sm" className="mr-2">Botão Primário</Button>
              ...
              <div className="mt-4 p-3 bg-card text-card-foreground rounded-md border">
                <p className="text-sm">Isto é um card dentro da pré-visualização.</p>
              </div>
            </div>
          </div>
