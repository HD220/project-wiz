...
export default function RepositorySettings() {
  const [repoUrl, setRepoUrl] = useState("https://github.com/user/project-name")
  const [accessToken, setAccessToken] = useState("ghp_1234567890abcdefghijklmnopqrstuvwxyz")
            ...
            {repositories.map((repo) => (
              <Card key={repo.id}>
                ...
                <CardContent>
                  ...
                  <div className="mt-4 text-xs text-muted-foreground">Last synced: {formatDate(repo.lastSync)}</div>
                </CardContent>
                <CardFooter className="flex justify-between">
                  ...
                  <Button variant={repo.status === "active" ? "destructive" : "default"} size="sm">
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure how the LLM interacts with your repositories</CardDescription>
            </CardHeader>
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="auto-pr">Automatically Create Pull Requests</Label>
                    <p className="text-sm text-muted-foreground">Allow the LLM to create branches and PRs for fixes</p>
                  </div>
                  <Switch id="auto-pr" checked={autoCreatePR} onCheckedChange={setAutoCreatePR} />
                </div>

                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="auto-docs">Automatically Generate Documentation</Label>
                    <p className="text-sm text-muted-foreground">
                      Allow the LLM to create and update documentation files
                    </p>
                  </div>
                  <Switch id="auto-docs" checked={autoGenerateDocs} onCheckedChange={setAutoGenerateDocs} />
                </div>

                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="auto-issues">Automatically Analyze Issues</Label>
                    <p className="text-sm text-muted-foreground">Allow the LLM to analyze and work on open issues</p>
                  </div>
                  <Switch id="auto-issues" checked={autoAnalyzeIssues} onCheckedChange={setAutoAnalyzeIssues} />
                </div>
              </div>
            </CardContent>
            <CardFooter>
        ...
        <TabsContent value="access" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Provide a GitHub personal access token with appropriate permissions</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Token requires: repo, workflow, and read:org scopes</p>
              </div>
