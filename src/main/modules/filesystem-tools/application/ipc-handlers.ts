...
export function registerFilesystemHandlers(cqrsDispatcher: CqrsDispatcher) {
  createIpcHandler<IpcFilesystemListDirectoryPayload, string[]>(
...
// }
  ...
  createIpcHandler<IpcFilesystemReadFilePayload, string>(
...
// }
  ...
  createIpcHandler<IpcFilesystemSearchFileContentPayload, string[]>(
...
// }
  ...
  createIpcHandler<IpcFilesystemWriteFilePayload, void>(
