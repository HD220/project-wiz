...
export class DomainError extends BaseError {
  ...
  static invalidBusinessRule(rule: string, details?: Record<string, any>): DomainError {
  ...
  static invalidState(currentState: string, expectedState: string, entity?: string): DomainError {
    return new DomainError(
