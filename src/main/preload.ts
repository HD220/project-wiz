...
const authAPI = {
  ...
  register: (input: RegisterInput) => ipcRenderer.invoke('auth:register', input),
...
const projectsAPI = {
  ...
  findById: (id: string) => 
    ipcRenderer.invoke('projects:find-by-id', id),
  ...
  addAgent: (projectId: string, agentId: string, role: string, userId: string) => 
...
const agentsAPI = {
  ...
  findById: (id: string) => 
    ipcRenderer.invoke('agents:find-by-id', id),
  ...
  start: (id: string) => 
    ipcRenderer.invoke('agents:start', id),
  stop: (id: string) => 
    ipcRenderer.invoke('agents:stop', id),
  getStatus: (id: string) => 
    ipcRenderer.invoke('agents:get-status', id),
...
const channelsAPI = {
  ...
  findById: (id: string) => 
    ipcRenderer.invoke('channels:find-by-id', id),
  listByProject: (projectId: string) => 
  ...
  reorder: (projectId: string, channelOrders: Array<{id: string, position: number}>, userId: string) => 
