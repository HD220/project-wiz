...
export type CreateUserPreferencesInput = Omit<InsertUserPreferences, "id" | "createdAt" | "updatedAt">;
export type UpdateUserPreferencesInput = Partial<InsertUserPreferences> & { id: string };
