...
import type { CreateLlmProviderDto, UpdateLlmProviderDto } from '../../../shared/types/llm-provider.types';
...
export interface ILlmProviderService {
  ...
  updateLlmProvider(id: string, data: UpdateLlmProviderDto): Promise<LlmProvider>;
