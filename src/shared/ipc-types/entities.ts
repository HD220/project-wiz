...
export interface IpcUserSettingsSavePayload { userId: string; key: string; value: string; }
export type IpcUserSettingsSaveResponse = IpcResponse<IUserSetting>;
export interface IpcUserSettingsGetPayload { userId: string; key: string; }
export type IpcUserSettingsGetResponse = IpcResponse<IUserSetting | undefined>;
export interface IpcUserSettingsListPayload { userId: string; }
export type IpcUserSettingsListResponse = IpcResponse<IUserSetting[]>;

// LLM Integration Module
export interface IpcLlmConfigSavePayload { id?: string; provider: string; model: string; apiKey: string; temperature: number; maxTokens: number; }
export type IpcLlmConfigSaveResponse = IpcResponse<ILlmConfig>;
export interface IpcLlmConfigGetPayload { id?: string; provider?: string; model?: string; }
...
export interface IpcLlmConfigRemovePayload { id: string; }
...
export interface IpcCodeAnalysisAnalyzeStackPayload { projectPath: string; }
...
export interface IpcForumCreateTopicPayload { title: string; authorId: string; }
export type IpcForumCreateTopicResponse = IpcResponse<IForumTopic>;
export interface IpcForumListPostsPayload { topicId: string; }
export type IpcForumListPostsResponse = IpcResponse<IForumPost[]>;
export interface IpcForumCreatePostPayload { topicId: string; authorId: string; content: string; }
export type IpcForumCreatePostResponse = IpcResponse<IForumPost>;

// Project Management Module
export interface IpcProjectCreatePayload { name: string; }
...
export interface IpcProjectRemovePayload { id: string; }
export type IpcProjectRemoveResponse = IpcResponse<boolean>;

// Direct Messages Module
export interface IpcDirectMessagesSendPayload { senderId: string; receiverId: string; content: string; }
export type IpcDirectMessagesSendResponse = IpcResponse<IDirectMessage>;
export interface IpcDirectMessagesListPayload { senderId: string; receiverId: string; }
export type IpcDirectMessagesListResponse = IpcResponse<IDirectMessage[]>;

// Persona Management Module
export interface IpcPersonaRefineSuggestionPayload { name: string; description: string; llmModel?: string; llmTemperature?: number; tools?: string[]; }
export type IpcPersonaRefineSuggestionResponse = IpcResponse<IPersona>;
export interface IpcPersonaCreatePayload { name: string; description: string; llmModel: string; llmTemperature: number; tools: string[]; }
...
export interface IpcPersonaRemovePayload { id: string; }
export type IpcPersonaRemoveResponse = IpcResponse<boolean>;

// Automatic Persona Hiring Module
export interface IpcAutomaticPersonaHiringHirePayload { projectId: string; projectPath: string; }
