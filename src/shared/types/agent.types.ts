...
export const CreateAgentSchema = z.object({
  ...
  role: z.enum(['developer', 'designer', 'tester', 'architect', 'pm', 'reviewer'], {
    errorMap: () => ({ message: 'Invalid role' })
  }),
  expertise: z.array(z.string()).max(10, 'Too many expertise areas').optional().default([]),
...
export const UpdateAgentSchema = z.object({
  ...
  role: z.enum(['developer', 'designer', 'tester', 'architect', 'pm', 'reviewer']).optional(),
