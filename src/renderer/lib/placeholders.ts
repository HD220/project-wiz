...
export const mockMessages: Message[] = [
  {
    ...
    reactions: [
      { emoji: '👍', count: 2, userIds: ['user-1', 'agent-2'] }
    ]
  },
  {
    id: 'msg-2',
    content: 'Preciso revisar o código do componente de checkout. Pode me ajudar?',
    type: 'text',
    authorId: 'user-1',
...
export const mockForumTopics: ForumTopic[] = [
  {
    ...
    content: 'Estou tendo dificuldades para configurar o ambiente local. Alguém pode me ajudar com o setup inicial?',
    authorId: 'user-1',
    authorName: 'João Silva',
    authorAvatar: 'https://github.com/shadcn.png',
  ...
  },
  {
    ...
    content: 'Quais são as melhores práticas para integrar com APIs de terceiros? Estou pensando em cache, rate limiting, etc.',
    authorId: 'user-2',
  ...
  },
  {
    ...
    content: 'Como vocês estruturam os testes? Unit tests, integration tests, e2e? Quais ferramentas recomendam?',
    authorId: 'user-3',
