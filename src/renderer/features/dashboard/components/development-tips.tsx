      ...
      <CardContent className="space-y-3">
        <div className="p-3 rounded-lg border bg-card">
          ...
          <p className="text-xs text-muted-foreground">
            Begin with simple agents and gradually increase complexity as you
            learn the platform.
          </p>
        </div>
        <div className="p-3 rounded-lg border bg-card">
          ...
          <p className="text-xs text-muted-foreground">
            Test your agents frequently and refine their prompts based on
            real-world usage.
          </p>
        </div>
        <div className="p-3 rounded-lg border bg-card">
          ...
          <p className="text-xs text-muted-foreground">
            Use projects to group related work and keep your workspace clean.
          </p>
        </div>
      </CardContent>
    </Card>
