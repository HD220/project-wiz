...
export function useChannelMessages(filter?: ChannelMessageFilterDto) {
  ...
  const mutations = useMemo(() => ({
    ...
    createTextMessage: (content: string, channelId: string, authorId: string, authorName: string) => 
      channelMessageStore.createTextMessage(content, channelId, authorId, authorName),
...
export function useChannelMessagesById(channelId: string) {
  ...
  return {
    ...
    deleteMessage: (messageId: string) => channelMessageStore.deleteMessage(messageId, channelId),
