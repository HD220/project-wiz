...
export class ApiClient {
  ...
  static async changePassword(data: { userId: string; currentPassword: string; newPassword: string }): Promise<void> {
  ...
  static async findProjectById(projectId: string): Promise<Project | null> {
    ...
    if (!response.success) {
      throw new Error(response.error || 'Failed to find project');
    }
    return response.data!;
  }
  ...
  static async findUserProjects(userId: string): Promise<Project[]> {
    ...
    if (!response.success) {
      throw new Error(response.error || 'Failed to find user projects');
    }
    return response.data!;
  }

  static async updateProject(data: { projectId: string; input: Partial<CreateProjectInput>; userId: string }): Promise<Project> {
  ...
  static async archiveProject(data: { projectId: string; userId: string }): Promise<void> {
  ...
  static async deleteProject(data: { projectId: string; userId: string }): Promise<void> {
  ...
  static async findAgentsByCreator(creatorId: string): Promise<Agent[]> {
    ...
    if (!response.success) {
      throw new Error(response.error || 'Failed to find agents');
    }
    return response.data!;
  }
  ...
  static async findProjectAgents(projectId: string): Promise<Agent[]> {
    ...
    if (!response.success) {
      throw new Error(response.error || 'Failed to find project agents');
    }
    return response.data!;
  }
  ...
  static async updateAgent(data: { agentId: string; input: Partial<CreateAgentInput>; userId: string }): Promise<Agent> {
  ...
  static async deleteAgent(data: { agentId: string; userId: string }): Promise<void> {
  ...
  static async getChannelMessages(data: { channelId: string; limit?: number; before?: string }): Promise<Message[]> {
  ...
  static async getDMMessages(data: { dmConversationId: string; limit?: number; before?: string }): Promise<Message[]> {
    const response = await window.electronAPI.getDMMessages(data);
    if (!response.success) {
      throw new Error(response.error || 'Failed to get DM messages');
    }
    return response.data!;
  }

  static async updateMessage(data: { messageId: string; content: string; authorId: string }): Promise<Message> {
  ...
  static async deleteMessage(data: { messageId: string; authorId: string }): Promise<void> {
