...
import { FileExplorer } from "@/features/development-tools/components/file-explorer";
import { TerminalPanel } from "@/features/development-tools/components/terminal-panel";
...
'Conteúdo do arquivo será exibido aqui...'}
                            ...
                            {selectedFile.lastModified && (
                              <div className="text-sm text-muted-foreground">
                                Última modificação: {selectedFile.lastModified.toLocaleString('pt-BR')}
                              </div>
                            )}
                          </div>
                        ) : (
