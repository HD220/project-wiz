...
export const ANNOTATION_REPOSITORY_INTERFACE_TYPE = Symbol.for(
...
export const LOGGER_INTERFACE_TYPE_APPLICATION =
  Symbol.for("ILoggerApplication");
// To differentiate if necessary, or reuse common
export const MEMORY_REPOSITORY_INTERFACE_TYPE = Symbol.for("IMemoryRepository");
export const LLM_PROVIDER_CONFIG_REPOSITORY_INTERFACE_TYPE = Symbol.for(
  "ILLMProviderConfigRepository"
);
export const AGENT_REPOSITORY_INTERFACE_TYPE = Symbol.for("IAgentRepository");
export const AGENT_INTERNAL_STATE_REPOSITORY_INTERFACE_TYPE = Symbol.for(
  "IAgentInternalStateRepository"
);
export const AGENT_PERSONA_TEMPLATE_REPOSITORY_INTERFACE_TYPE = Symbol.for(
  "IAgentPersonaTemplateRepository"
);
export const SOURCE_CODE_REPOSITORY_INTERFACE_TYPE = Symbol.for(
  "ISourceCodeRepository"
);
export const USER_REPOSITORY_INTERFACE_TYPE = Symbol.for("IUserRepository");
export const PROJECT_REPOSITORY_INTERFACE_TYPE =
  Symbol.for("IProjectRepository");
...
export const TOOL_REGISTRY_SERVICE_INTERFACE_TYPE = Symbol.for(
  "IToolRegistryService"
);
export const AGENT_EXECUTOR_INTERFACE_TYPE = Symbol.for("IAgentExecutor");
export const AGENT_STATE_SERVICE_INTERFACE_TYPE =
  Symbol.for("IAgentStateService");
export const AGENT_INTERACTION_SERVICE_INTERFACE_TYPE = Symbol.for(
  "IAgentInteractionService"
);
export const AGENT_TOOL_SERVICE_INTERFACE_TYPE =
  Symbol.for("IAgentToolService");
export const TOOL_VALIDATION_SERVICE_INTERFACE_TYPE = Symbol.for(
  "IToolValidationService"
);
export const GENERIC_AGENT_EXECUTOR_INTERFACE_TYPE = Symbol.for(
  "IGenericAgentExecutor"
);
...
// src/infrastructure/ioc/types.ts should ideally be removed or its usage confined to the infrastructure layer itself,
...
// The `src/infrastructure/ioc/types.ts` file will eventually be simplified or removed.
