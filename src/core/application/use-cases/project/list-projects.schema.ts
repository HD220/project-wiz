// src/core/application/use-cases/project/list-projects.schema.ts
import { z } from "zod";
 ...
 */
export const ListProjectsUseCaseInputSchema = z
  .object({
...
export type ListProjectsUseCaseInput = z.infer<
  typeof ListProjectsUseCaseInputSchema
>;
...
export type ListProjectsUseCaseOutput = z.infer<
  typeof ListProjectsUseCaseOutputSchema
>;
