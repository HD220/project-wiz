// src/core/application/queue/events/job-event.types.ts
...
export interface JobAddedPayload<
  PayloadType extends { userId?: string },
  ReturnType = unknown,
> {
  job: JobEntity<PayloadType, ReturnType>;
}

export interface JobFetchedPayload<
  PayloadType extends { userId?: string },
  ReturnType = unknown,
> {
  job: JobEntity<PayloadType, ReturnType>;
...
export interface WorkerJobInterruptedPayload<
  PayloadType extends { userId?: string },
  ReturnType = unknown,
> {
