// src/core/application/queue/abstract-queue.ts
...
export const getQueueServiceToken = (queueName: string) =>
  `${QUEUE_SERVICE_TOKEN_PREFIX}${queueName}`;
