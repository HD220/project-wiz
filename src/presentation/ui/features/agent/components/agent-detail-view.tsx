...
import { AgentActivityLogCard } from "@/ui/features/agent/components/agent-activity-log-card";
import { AgentDetailContent } from "@/ui/features/agent/components/agent-detail-content";
import { AgentDetailHeader } from "@/ui/features/agent/components/agent-detail-header";
