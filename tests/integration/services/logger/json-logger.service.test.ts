...
describe("JsonLogger - Integration Tests", () => {
  ...
  describe("info", () => {
    it("deve logar mensagens de info no formato JSON", () => {
  ...
  describe("error", () => {
    it("deve logar mensagens de erro no formato JSON", () => {
  ...
  describe("withJobContext", () => {
    it("deve adicionar contexto de job aos logs", () => {
      const job = {
        getId: () => "job-123",
