...
export type AnalyseCodeWorkerData = {
  filePath: string;
  commitHash: string;
  previousCommitHash?: string;
};

export const analyseCodeQueue =
  createQueue<AnalyseCodeWorkerData>("analyse-code");
export const analyseCodeWorker = createWorker<AnalyseCodeWorkerData>(
  "analyse-code",
  async (job, token) => {
