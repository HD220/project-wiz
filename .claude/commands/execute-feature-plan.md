...
- **Seguir padrões**: Usar exatamente os padrões identificados na codebase
...
- Começar pela estrutura base (entidades, schemas)
- Implementar camada por camada (domain → application → persistence → ipc → ui)
